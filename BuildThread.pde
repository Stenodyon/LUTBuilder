void buildThread(){
  ...
  */
  ...
  for(float i=5000;i>0;i--){ //5 second delay with countdown
    float startTime = millis();
    splash = "Building Circuit in " + ceil(i/1000);
    progress = i/5000;
    while(millis()-startTime<1); //more accurate way of delaying 1 millisecond
  }
