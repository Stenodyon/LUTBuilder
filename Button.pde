class Button
{
    ...
    public void IsActive(boolean val) { this.active = val; }
    ...
    /*
       Draws the button with x,y representing the top left corner, width is how far right it spans, height is how far down it spans
     */
    public void Draw()
    {
        pushStyle();
